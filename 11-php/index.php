    ...
    <main class="container">
        <div class="row">
            ...
            <div class="btn-group-vertical" role="group" aria-label="Vertical button group" style="width: 24rem">
                ...
                <a href="26-ssi.php"                        class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">26</span> Server Side Include (Ssi)</a>
                <a href="27-file-text.php"                  class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">27</span> File Text</a>
                <a href="28-upload-files.php"               class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">28</span> Upload Files</a>
                <a href="29-cookies.php"                    class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">29</span> Cookies</a>
                <a href="30-sesions.php"                    class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">30</span> Sesions</a>
                <a href="31-send-mail.php"                  class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">31</span> Send Mail</a>
                <a href="32-exceptions.php"                 class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">32</span> Exceptions</a>
                <a href="33-filters.php"                    class="btn btn-outline-info text-start"                  ><span class="badge rounded-pill bg-info">33</span> Filters</a>
